...
func ExtractRootfs(rootfsPath string) error {
	...
	missingApplets := []string{"sleep", "kill", "pkill", "killall", "stat", "passwd", "chpasswd", "adduser", "addgroup", "deluser", "delgroup", "wc", "head", "tail", "tr", "cut", "more", "strings", "diff", "readlink", "unzip"}
